<x-base-layout>
    <div class="card">
        <div class="card-body pt-6">
            ...
            <h1 class="p-6">Додати нову викрадену машину</h1>
            ...
            {{ Form::open(array('url' => 'autos/registration', 'id' => 'kt_docs_formvalidation_text')) }}

            <div class="fv-row mb-12">
                <span>
                    {{ Form::label('owner_name', 'Ім\'я', array('class' => 'required fw-bold fs-6 mb-2')) }}
                    {{ Form::text('owner_name', Request::old('owner_name'), array('class' => 'form-control mb-2 mb-md-0')) }}
                </span>
            </div>
            <div class="fv-row mb-12">
                <span>
                    {{ Form::label('state_number', 'Державний номер', array('class' => 'required fw-bold fs-6 mb-2')) }}
                    {{ Form::text('state_number', Request::old('state_number'), array('class' => 'form-control mb-2 mb-md-0')) }}
                </span>
            </div>
            <div class="fv-row mb-12">
                <span>
                    {{ Form::label('color', 'Колір', array('class' => 'required fw-bold fs-6 mb-2')) }}
                    {{ Form::text('color', Request::old('color'), array('class' => 'form-control mb-2 mb-md-0')) }}
                </span>
            ...
            <div class="fv-row mb-12">
                <span>
                    ...
                    {{ Form::text('vin_code', Request::old('vin_code'), array('class' => 'form-control mb-2 mb-md-0', 'id' => 'vin_code')) }}
                </span>
            </div>
            <div class="fv-row mb-12">
                <span>
                    {{ Form::label('brand', 'Марка', array('class' => 'required fw-bold fs-6 mb-2')) }}
                    {{ Form::text('brand', Request::old('brand'), array('class' => 'form-control mb-2 mb-md-0', 'id' => 'brand')) }}
                </span>
            ...
            <div class="fv-row mb-12">
                <span>
                    ...
                    {{ Form::text('model', Request::old('model'), array('class' => 'form-control mb-2 mb-md-0', 'id' => 'model')) }}
                </span>
            </div>
            <div class="fv-row mb-12">
                <span>
                    {{ Form::label('year', 'Рік випуску', array('class' => 'required fw-bold fs-6 mb-2')) }}
                    {{ Form::text('year', Request::old('year'), array('class' => 'form-control mb-2 mb-md-0 disabled', 'year')) }}
                </span>
            </div>
            <!--begin::Actions-->
